          ...
          >
            ...
            >
              <ul class="timeline clearfix">
                ...
                <li class="timeline-item">
                  <div class="timeline-badge">
                    <i class="badge-icon bg-primary text-white i-Cloud-Picture" />
                  </div>
              ...
              <ul class="timeline clearfix">
                ...
                <li class="timeline-item">
                  <div class="timeline-badge">
                    <i class="badge-icon bg-danger text-white i-Love-User" />
                  </div>
                  <div class="timeline-card card">
                    <div class="card-body">
                      <div class="mb-1">
            ...
            <b-tab title="About">
              ...
              <div class="row">
                <div class="col-md-4 col-6">
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Calendar text-16 mr-1" /> Birth Date
                    </p>
                    <span>1 Jan, 1994</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Edit-Map text-16 mr-1" /> Birth Place
                    </p>
                    <span>Dhaka, DB</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Globe text-16 mr-1" /> Lives In
                    </p>
                    <span>Dhaka, DB</span>
                  </div>
                </div>
                <div class="col-md-4 col-6">
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-MaleFemale text-16 mr-1" /> Gender
                    </p>
                    <span>1 Jan, 1994</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-MaleFemale text-16 mr-1" /> Email
                    </p>
                    <span>example@ui-lib.com</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Cloud-Weather text-16 mr-1" /> Website
                    </p>
                ...
                <div class="col-md-4 col-6">
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Face-Style-4 text-16 mr-1" /> Profession
                    </p>
                    <span>Digital Marketer</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Professor text-16 mr-1" /> Experience
                    </p>
                    <span>8 Years</span>
                  </div>
                  <div class=" mb-30">
                    <p class="text-primary mb-1">
                      <i class="i-Home1 text-16 mr-1" /> School
                    </p>
              ...
              <p class=" mb-30">
                Lorem ipsum dolor sit amet consectetur adipisicing elit. Ipsum dolore labore reiciendis ab quo ducimus reprehenderit natus debitis, provident ad iure sed aut animi dolor incidunt voluptatem. Blanditiis, nobis aut.
              </p>

              <div class="row">
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Plane text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Travelling
                  </p>
                </div>
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Camera text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Photography
                  </p>
                </div>
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Car-3 text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Driving
                  </p>
                </div>
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Gamepad-2 text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Gaming
                  </p>
                </div>
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Music-Note-2 text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Music
                  </p>
                </div>
                <div class="col-md-2 col-sm-4 col-6 text-center">
                  <i class="i-Shopping-Bag text-32 text-primary" />
                  <p class="text-16 mt-1">
                    Shopping
                  </p>
                </div>
                ...
                <b-col md="3">
                  <b-card class="card-profile-1 mb-30 text-center">
                    ...
                    <div class="card-socials-simple mt-4">
                      <a href="">
                        <i class="i-Linkedin-2" />
                      </a>
                      <a href="">
                        <i class="i-Facebook-2" />
                      </a>
                      <a href="">
                        <i class="i-Twitter" />
                      </a>
