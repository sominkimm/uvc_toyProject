            ...
            <b-row>
              ...
              >
                <div class="ul-pricing__table-1">
                  ...
                  <div class="ul-pricing__text text-mute">
                    5gb
                  </div>
                  <div class="ul-pricing__main-number">
                    <h3 class="heading display-3 text-primary t-font-boldest">
                      $10
                    </h3>
                  </div>
                  ...
                  <button
                    type="button"
                    class="btn btn-lg btn-default btn-rounded m-1"
                  >
                    Purchase
                  </button>
                </div>
          ...
          <b-row>
            ...
            >
              <div class="ul-pricing__table-1 mb-4">
                ...
                <button
                  type="button"
                  class="btn btn-lg btn-primary btn-rounded m-1"
                >
                  Purchase
                </button>
              </div>
              ...
              <div class="ul-pricing__table-2">
                <div class="ul-pricing__header">
                  ...
                  <div class="ul-pricing__main-number m-0">
                    <h1 class="heading text-primary t-font-boldest">
                      $0.00
                    </h1>
                  </div>
            ...
            >
              <div class="ul-pricing__table-2">
                <div class="ul-pricing__header">
                  ...
                  <div class="ul-pricing__main-number m-0">
                    <h1 class="heading text-warning t-font-boldest">
                      $10
                    </h1>
                  </div>
                  <div class="ul-pricing__month">
                ...
                <button
                  type="button"
                  class="btn btn-lg btn-warning btn-rounded m-1"
                >
                  Purchase
                </button>
              </div>
            ...
            >
              <div class="ul-pricing__table-2">
                <div class="ul-pricing__header">
                  ...
                  <div class="ul-pricing__main-number m-0">
                    <h1 class="heading text-danger t-font-boldest">
                      $250
                    </h1>
                  </div>
                  <div class="ul-pricing__month">
                ...
                <button
                  type="button"
                  class="btn btn-lg btn-danger btn-rounded m-1"
                >
                  Purchase
                </button>
              </div>
              ...
              <div class="ul-pricing__table-2 border-right-0">
                <div class="ul-pricing__header">
                  <div class="ul-pricing__image text-success m-0">
                    <i class="i-Helicopter" />
                  </div>
                  <div class="ul-pricing__main-number m-0">
                    <h1 class="heading text-success t-font-boldest">
                      $500
                    </h1>
                  </div>
                  <div class="ul-pricing__month">
                ...
                <button
                  type="button"
                  class="btn btn-lg btn-success btn-rounded m-1"
                >
                  Purchase
                </button>
              </div>
